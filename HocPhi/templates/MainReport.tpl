...
<p style='margin-top:0in;margin-right:0in;margin-bottom:0in;margin-left:0in;line-height:18.0pt;font-size:15px;font-family:"Times New Roman";text-align:justify;'>
    <span class="chu">Họ và tên học sinh:</span><strong>
        
        <strong><span style='font-size:19px;font-family:"Times New Roman";color:red;'>{{ tienNop.Hoten_HocSinh }}</span></strong>
        <span class="chu">Lớp<strong>:&nbsp;</strong></span><strong>
            <span style='font-size:19px;font-family:"Times New Roman";color:red;'>{{ tienNop.Lop }}</span></strong><strong>
                <span class="chu">&nbsp; &nbsp; &nbsp;&nbsp;</span></strong>
                <span class="chu">Mã học sinh<strong>:&nbsp;</strong></span><strong>
                    <span style='font-size:19px;font-family:"Times New Roman";color:red;'>{{ tienNop.ma_hs }}</span></strong></p>
...
<table width="700" class="mainTable">
  <tbody>
    ...
    <tr>
      <td height="350"><table class="demTable">
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td><img style="width: 83pt; height: 83pt;" src="{{ item.QRcode }}" alt="image" /></td>
    </tr>
	     {% endfor %}
	    <tr>
		<td  colspan="2">Tổng Cộng<br></td>
		<td ><span style="color: #ff0000;"><strong>{{ tienNop.Tong_So_Tien | format_number:"N0" }}</strong></span></td>
		<td >
				</td>
	  </tr>
  </tbody>
      ...
      <td height="350"> <p> <span> <img style="width: 141pt; height: 141pt;" src="{{ qrcode_full }}" alt="image"></span> <br>
        </p>
        <p><span>Tổng Cộng:</span><span style="color: #ff0000;"><strong>{{ tienNop.Tong_So_Tien | format_number:"N0" }}</strong></span></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<p style='margin-top:0in;margin-right:0in;margin-bottom:8.0pt;margin-left:0in;line-height:20.0pt;font-size:15px;font-family:"Times New Roman";text-align:justify;'><em><span class="span_t">+ <strong><u>Lưu ý:</u></strong> Quý phụ huynh dùng app các Ngân hàng (như Smartbanking của BIDV, VCB…) hoặc các ví điện tử (như Zalopay,…) để lựa chọn 1 trong 2 cách quét QRcode trên để thanh toán tiền học cho con , vui lòng không điều chỉnh nội dung chuyển tiền.</span></em></p>
